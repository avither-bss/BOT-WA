...
const starts = async (dha = new WAConnection()) => {
	...
	console.log(color(figlet.textSync('YUVI BOT', {
		font: 'Standard',
	...
	dha.on('connecting', () => {
		console.log(color('[ DENARA BOT ]', 'yellow'), color('PROSES NYAMBUNG...'));
	})
const spinner = { 
  "interval": 120,
  "frames": [
	...
	//connect
	dha.on('open', () => {
		console.log(color('[ DENARA BOT ]', 'yellow'), color('BOT SUDAH AKTIF  SELAMAT MENGGUNAKAN'));
	})
