...
petik = '```'
fake = '© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 Avither'//GANTI NAMA KAMU BEP
ban =[]
...
module.exports = dha = async (dha, mek) => {
	try {
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = dha.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "Pilih Disini","footerText": "© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 Avither","listType": "SINGLE_SELECT","sections": list}}, {})
     ...
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
       ...
       console.error(err)
        ...
        const ftoko = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./media/sherlynn.jpg`)},"title": `© YuviBot`,"description": "ℭ𝔯𝔢𝔞𝔱𝔬𝔯 Avither", "currencyCode": "IDR","priceAmount1000": "999999","retailerId": "YuviBot","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
...
*Sewa bot?* Chat wa.me/6282141525747`
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: '© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 Avither7', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
*Cek list Server GTLI dibawah!*`
               ...
               footerText: '© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 Avither', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
*Cek list Server GTIVD dibawah!*`
       ...
       case 'othercmd':
               ...
               startnum = 0
               for (let x of listmenu) {
               const yy = {title: '© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 Avither ' + nombor++,
                    rows: [
                       {
                        title: `${listmenuu[startnum++]}`,
                        description: ``,
       ...
       case 'store':
               ...
               listmsg(from, `${ucapanWaktu}`,   `© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 Avither`, list)
               break
//------------------< Game >------------------- 
        case 'limitgame': 
        case 'balance': 
...
*Link Grup :* https://chat.whatsapp.com/LL69TwtWnDGIsQhpfPEpfC
...
*Chat Owner :* wa.me/6285727492435`
              dha.sendMessage(from, await getBuffer(gopeynya), image, {quoted: ftoko, caption: teksnya })
              break
case 'pricegtfo':
              gopeynya = 'https://i.ibb.co/kynNYTh/ganteng.jpg'
...
*Untuk selengkapnya open Member bisa hubungin Kapten(AVITHER)*
*Wajib Nge team tour!!*
...
*ID FF :* GAPUNYA
*Mending gabut aja ama owner :)* wa.me/6282141525747
#WAVEFOREVER!`
              dha.sendMessage(from, await getBuffer(gopeynya), image, {quoted: ftoko, caption: teksnya })
              break
...
case 'tiktok':
              ...
              imageMsg = (await dha.prepareMessageMedia(fs.readFileSync(`./media/sherlynn.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/sherlynn.jpg`)})).imageMessage
              buttonsMessage = {footerText:'BERES...', imageMessage: imageMsg,
       ...
       case 'img2url':
         ...
         case 'asupan': // shansekai                
              ...
              .then(async (body) => {
               ...
               sendMediaURL(from, `http://sansekai.my.id/ptl_repost/${asupanx}`, '\`\`\`ASUPAN BRO GUA DAPAT DARI 𝔇𝔢𝔫𝔞𝔯𝔞 𝔅𝔬𝔱𝔰\`\`\`')
...
dha.sendMessage(from, tapib1, document, { quoted: mek, filename:`𝔇𝔢𝔫𝔞𝔯𝔞 𝔅𝔬𝔱𝔰 ~ 404 ${vipi}.mp3`, mimetype: 'audio/application' })
...
"groupName": `𝔇𝔢𝔫𝔞𝔯𝔞 𝔅𝔬𝔱𝔰 ~ 404 ${vipi}`,
...
//------------------< Ingfo Bot >-------------------
      case 'runtime':
              ...
              break
       case 'youtube': 
              reply(`*Subcribe YT Owner :*\n https://youtube.com/channel/UCcOCTySo6X1K5tziHZxq7Qw`)
              break
       case 'masukandata':
...
dha.sendMessage(_.jid, 
			{"contentText": `*「 Siaran YuviBot 」*\n© YuviBot\n*Isi Pesan :* ${body.slice(4)}`,
			"footerText": '© ℭ𝔯𝔢𝔞𝔱𝔬𝔯 Avither',
			"buttons": [
...
case 'caripesan':  //by ANU TEAM
       ...
       case 'bugreport':
              ...
              dha.sendMessage('6285727492435@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'readall':
...
//------------------< Menunya Bang:v >-------------------
      case 'dana':
         ...
         case 'pulsa':
             ...
             break              
      case 'infoig':
             reply(`Follow Instagram Owner Ya : https://www.instagram.com/_avither_id`)
             break
      case 'grupbot':
             reply('Gaada :)')
             break
